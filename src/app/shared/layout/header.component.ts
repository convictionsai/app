...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, RouterLink, IconComponent, ReactiveFormsModule, SearchBarComponent],
    template: `
        <header class="">
            <nav class="bg-purple-400 shadow-2xl border-b-4 border-purple-500">
                <div class="flex flex-wrap items-center px-4 py-2.5 gap-8">
                    ...
                    <div class="flex flex-1">
                        ...
                        <!--                            </svg>-->
                        <!--                        </button>-->
                        <convictionsai-search-bar></convictionsai-search-bar>
                        <!--                        <div-->
                        <!--                            id="dropdown"-->
...
export class HeaderComponent {
    public searchControl = new FormControl("What is the meaning of life?", [Validators.required, Validators.minLength(3), Validators.maxLength(255)]);

    public constructor(public readonly authenticationService: AuthenticationService, private readonly router: Router) {}

    public search(): void {
        console.log(this.searchControl.value);
        void this.router.navigate(["search"], { queryParams: { q: this.searchControl.value } });
    }
}
