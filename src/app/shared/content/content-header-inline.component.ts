...
@Component({
    ...
    template: `
        <div class="flex justify-between items-center pb-4">
            <div class="">
                <h2 class="text-2xl tracking-tight text-purple-700">{{ title }}</h2>
            ...
            <div class="">
                <a class="inline-flex justify-center items-center p-3 cursor-pointer text-base font-medium text-gray-600 bg-gray-100 rounded-lg hover:text-gray-900 hover:bg-gray-100">
