...
@Component({
    selector: "convictionsai-editor",
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
            <div class="flex items-center justify-between border-b py-2 px-3 dark:border-gray-600">
            ...
            <div class="rounded-b-lg bg-white py-2 px-4 dark:bg-gray-800">
                <textarea
                    id="description"
                    rows="8"
