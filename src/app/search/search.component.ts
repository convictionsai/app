            ...
            <main class="pt-4">
                <div class="flex justify-between px-4">
                    <article class="flex flex-col gap-4">
                        <header class="">
                            <h1 class="mb-2 text-3xl font-extrabold leading-tight text-gray-700">
                                {{ $any(result).prompt }}
                            </h1>
                            <div class="text-sm">By Convictions Bot in {{ $any(result).time | number }}ms.</div>
                        </header>
                    ...
                    <aside class="w-72" aria-labelledby="sidebar-label">
                        <div class="">
                            <h3 id="sidebar-label" class="sr-only">Sidebar</h3>
                            <div class="px-6 mb-6 text-gray-500 rounded-lg border border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                <a href="#" class="flex items-center mb-4">
                                    ...
                                    <div class="mr-3">
                                        <span class="block font-medium text-gray-900 dark:text-white">Matthew Davis</span>
                                        <span class="text-sm">34k followers</span>
                                    </div>
                                </a>
                                <p class="mb-4 text-sm text-gray-500 dark:text-gray-400">So be it what may come.</p>
                                <dl class="mb-5">
                                    <dt class="mb-2 text-sm font-bold text-gray-900 uppercase dark:text-white">Location</dt>
                                    <dd class="mb-3 text-sm text-gray-500 dark:text-gray-400">Nowhere, United States</dd>
                            ...
                            <div class="p-6 mb-6 font-medium text-gray-500 rounded-lg border border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <a href="#" class="bg-primary-100 text-primary-800 text-sm font-medium mr-3 px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">Design</a>
                            ...
                            <div class="p-6 font-medium text-gray-500 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <ul class="space-y-4 font-light text-gray-500 dark:text-gray-400">
                                    <li class="flex justify-between items-start">
                                        <div class="mr-3 shrink-0">
                                            <img class="mt-1 w-6 h-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg" alt="Bonnie Green" />
                                        </div>
                                        <div class="mr-3">
                                    ...
                                    <li class="flex justify-between items-start">
                                        <div class="mr-3 shrink-0">
                                            <img class="mt-1 w-6 h-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Jese Leos" />
                                        </div>
                                        <div class="mr-3">
                                            <span class="block font-medium text-gray-900 dark:text-white">Jese Leos</span>
                                            <span class="text-sm">Software enginner at Alphabet Inc.</span>
                                        </div>
                                        <div>
                                            <button
                                                type="button"
                                    ...
                                    <li class="flex justify-between items-start">
                                        <div class="mr-3 shrink-0">
                                            <img class="mt-1 w-6 h-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Paul Livingston" />
                                        </div>
                                        <div class="mr-3">
                ...
                <div class="px-4 mx-auto max-w-screen-xl">
                    ...
                    <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <article class="max-w-xs">
                            ...
                            <p class="mb-4 font-light text-gray-500 dark:text-gray-400">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
                            <a href="#" class="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 dark:text-primary-500 hover:no-underline"> Read in 4 minutes </a>
                        </article>
                    </div>
                </div>
            </aside>
